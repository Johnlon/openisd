...
const stats = computed(() => {
  ...
  return { box, Vb: p.Vb, fc, Qtc, fb, fp, f3, peakZ, maxPV, maxPRx, ebpVal: ebp(d), prXmax: p.prXmax };
});
</script>
