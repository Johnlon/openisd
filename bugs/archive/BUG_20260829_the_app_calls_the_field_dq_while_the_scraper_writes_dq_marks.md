...
Status: RESOLVED — name mismatch already gone (`dq_scraper` written since 2026-08); producer split now enforced by this plan (D9–D22, `PLAN_RETIRE_CALCS_FROM_SCRAPERS.md`).
