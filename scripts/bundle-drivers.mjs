...
const bundle = {
  _generated: 'AUTO-GENERATED by scripts/bundle-drivers.mjs — DO NOT EDIT MANUALLY. ' +
    'This file is rebuilt on every `npm run dev` and `npm run build` (prebuild hook). ' +
    'Source data lives in drivers/**/*.wdr and drivers/**/_meta.yml. ' +
    'Edits here will be silently overwritten on the next build.',
  sources: [],
};
