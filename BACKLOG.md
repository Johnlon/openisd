...
- [ ] **P3** Extend unit toggles to the Modern/Classic calculated readouts (Fp, Fs, Vas summaries in `PRPanel`) and the `StatBar` summary strip — currently fixed-unit; the Original skin already converts its calculated readouts. `[ui]`
