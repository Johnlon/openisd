...
scripts/    — Python scrapers, DQ check, schema validation
drivers/    — WDR + _meta.yml files per collection (gitignored: _html/, datasheets/)
```
...
- Schema: `wdr_meta_schema.py` is the single source of truth
