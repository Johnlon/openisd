...
[WDR_SCHEMA.md §4](http://localhost:8000/winisd/openisd/docs/design/WDR_SCHEMA.md#L248-L271) already
...
([WDR_SCHEMA.md:232-234](http://localhost:8000/winisd/openisd/docs/design/WDR_SCHEMA.md#L232-L234)). The
...
| 19    | Xmax, Hc, Hg         | `Xmax = abs(Hc−Hg)/2`                | **Observed firing in WinISD** — probe `A_hchg_only`/`C_all_four`, [`runs/xmax_route.jsonl`](http://localhost:8000/winisd/winisd_research/runs/xmax_route.jsonl); matches the help text, [thielesmall.html](http://localhost:8000/winisd/openisd/research/winisd/help/thielesmall.html#L180-L182): _"usually calculated as abs(Hc-Hg)/2 … WinISD does not multiply with any of these factors"_ | not derived (stores `missing:Xmax`)                                                                                                                                                                                                                                                                                | live — `Driver#derive()` calls `solveConsistencyGroup` directly (§3)                                                              | live: [`:151-152`](http://localhost:8000/winisd/openisd/packages/engine/src/driver.ts#L151-L152), evaluated ahead of row 20                                                                                                                                                                                         |
...
- WinISD's own file-level equivalent (`ParState`) is independently, correctly implemented on
  ...
  [WDR_SCHEMA.md:386](http://localhost:8000/winisd/openisd/docs/design/WDR_SCHEMA.md#L386).
