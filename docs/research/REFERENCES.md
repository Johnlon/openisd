...
- **Sourcing pass done for the wizard's 5-option vented dropdown** (BB4/SBB4, C4/SC4
  formulas found and cited; EBS3/EBS6 not found anywhere public) —
  [`VENTED_ALIGNMENT_FORMULAS.md`](VENTED_ALIGNMENT_FORMULAS.md?html).
...
notes, gaps) live in [`COMPETITIVE_LANDSCAPE.md`](COMPETITIVE_LANDSCAPE.md); this is the
reference index.

- **WinISD** — the desktop incumbent OpenISD emulates; `.wdr` file format is our
  interchange baseline. <http://www.linearteam.org/> · see
  [`WINISD_PARITY.md`](WINISD_PARITY.md).
- **micka.de** — sealed + vented cross-check oracle (`#ideal` calculator; no
  PR/bandpass). <https://www.micka.de/en/index.php> · see
  [`COMPETITIVE_LANDSCAPE.md` "SpeakerBoxLite"](COMPETITIVE_LANDSCAPE.md) and
  [`../plans/archive/PLAN_SBL_CROSSCHECK.md`](../plans/archive/PLAN_SBL_CROSSCHECK.md).
- **SpeakerBoxLite** — second oracle covering PR + bandpass.
  <https://speakerboxlite.com/subwoofer-box-calculator/> · see
  [`COMPETITIVE_LANDSCAPE.md` "SpeakerBoxLite"](COMPETITIVE_LANDSCAPE.md).
- **SpeakerDesign.dev** — free browser toolkit self-billed as a "web-based WinISD
  ...
  [`COMPETITIVE_LANDSCAPE.md` "SpeakerDesign.dev"](COMPETITIVE_LANDSCAPE.md).
- **Sonella** — guided DIY full-range design app (Dayton drivers, crossover, STL
  export). <https://sonella.app/> · see
  [`COMPETITIVE_LANDSCAPE.md` "Sonella"](COMPETITIVE_LANDSCAPE.md).
- **00 Audio Simulator** — closest web competitor; imports `.wdr`, covers
  ...
  <https://simulator.00aud.io/> · see
  [`COMPETITIVE_LANDSCAPE.md` "00 Audio Simulator"](COMPETITIVE_LANDSCAPE.md).
- **SoundForm** — closed-beta web WinISD app (crossover + multi-driver summation focus);
  ...
  · see [`COMPETITIVE_LANDSCAPE.md` "SoundForm"](COMPETITIVE_LANDSCAPE.md).
- **LoudspeakerLab** — automated passive-crossover + system solver (ABCD-matrix model,
  ...
  · see [`COMPETITIVE_LANDSCAPE.md` "LoudspeakerLab"](COMPETITIVE_LANDSCAPE.md).
