/**
 * Builds `packages/winisd/dist/openisd-bridge.js` — the single-file IIFE embedded-V8 bridge
 ...
 * (`packages/model/src/openisdYamlToWdr.ts:19`) MUST be inlined, not left as a runtime
...
export default defineConfig({
  ...
  build: {
    ...
    // TypeScript source (src/bridge.ts) and this config, both checked in; the dist artifact
