...
const RANGES: Record<string, { min: number; max: number }> = {
  ...
  Xmax: { min: 0,      max: 500   },  // mm (0 = omitted — optional field, drops the limit line)
  Pe:   { min: 0,      max: 50000 },  // W  (0 = omitted — optional field, drops the power curve)
};
  ...
  <fieldset>
    ...
    <template v-else>
      ...
      <div class="row"><label>Fs</label>
        <input v-expo-step type="number" v-limits step="any" min="1" max="5000"
      ...
      <div class="row"><label>Qts</label>
        <input v-expo-step type="number" v-limits step="any" min="0.01" max="20"
      ...
      <div class="row"><label>Qms</label>
        <input v-expo-step type="number" v-limits step="any" min="0.05" max="200"
      ...
      <div class="row"><label>Vas</label>
        <input v-expo-step type="number" v-limits step="any" min="0.001" max="10000"
      ...
      <div class="row"><label>Re</label>
        <input v-expo-step type="number" v-limits step="any" min="0.1" max="300"
      ...
      <div class="row"
        ...
        <input v-expo-step type="number" v-limits step="any" min="0" max="100"
      ...
      <div class="row"
        ...
        <input v-expo-step type="number" v-limits step="any" min="0" max="50000"
