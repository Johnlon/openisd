...
<template>
  <header>
    ...
    <h1>OpenISD<span style="color:var(--acc)"> ~</span> &nbsp;
      <small>opensource interactive speaker designer · community-owned · runs anywhere</small>
    </h1>
    <div class="sp"></div>
    ...
    <SkinPicker />
    <input ref="fileInput" type="file" accept=".owpr,.wpr,.owdr,.wdr,.json" style="display:none" @change="onFileChange">
