...
const FIELDS: FieldSpec[] = [
  ...
  { id: 'AlfaVC', label: 'AlfaVC', pane: 'Driver: Advanced', kind: 'number', unit: '1000/K', precision: 4, min: 0, provenance: 'entered', modeled: false, appliesTo: 'all', description: 'Voice-coil resistance temperature coefficient. Labelled "Voice coil resistance TC" on the Driver placement pane (copper 3.9000), "AlfaVC" on the editor Advanced tab; 4 dp. WinISD 0.7.0.950 DOES use it — scales hot Re with the temp rise (verified 2026-07-21, WINISD.md §12c; WinISD legacy help text wrongly calls it unused). Not modelled by OpenISD.' },
  ...
  { id: 'vcTempRise', label: 'Voice coil temp rise', pane: 'Driver', kind: 'number', unit: 'K', precision: 2, min: 0, provenance: 'entered', modeled: false, appliesTo: 'all', description: 'Voice-coil ΔT above ambient (0.00 K, 2 dp). WinISD 0.7.0.950 DOES simulate it — Re(hot)=Re·(1+AlfaVC·ΔT) → power compression (verified 2026-07-21, WINISD.md §12c). OpenISD does not model power compression yet (assumes cold, constant Re).' },
  { id: 'driverAddedMass', label: 'Added mass to cone', pane: 'Driver', kind: 'number', unit: 'g', precision: 5, min: 0, provenance: 'entered', modeled: false, appliesTo: 'all', description: 'Driver-side added cone mass (0.00000 g, 5 dp — native grams, verified via Fs shift 70→25 Hz for +100 g, WINISD.md §12c). WinISD adds it into Mms (lowers Fs, raises Qts). OpenISD models PR added mass only, not driver-side.' },
