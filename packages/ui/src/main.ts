...
// ONE engine for the whole app — `appState`'s, not a second instance built here. The engine
// carries the application settings, so a second one would answer the same plausibility question
