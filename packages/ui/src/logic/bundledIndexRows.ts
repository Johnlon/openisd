 ...
 *
 * Figures are `.value` — the value the app shows, stated or solved — matching what
...
export function bundledDriverIndexRowOf(driver: OpenISDDriver, path: string): BundledDriverIndexRow {
  ...
  return {
    ...
    Fs_hz: s.Fs_hz.value,
    Sd_m2: s.Sd_m2.value,
    Xmax_m: s.Xmax_m.value,
    Vd_m3: s.Vd_m3.value,
    Znom_ohm: s.Znom_ohm.value,
  };
}
...
export function bundledPassiveRadiatorIndexRowOf(radiator: OpenISDPassiveRadiatorStandalone, path: string): BundledPassiveRadiatorIndexRow {
  ...
  return {
    ...
    Xmax_m: s.Xmax_m.value,
    Vd_m3: s.Vd_m3.value,
    Mms_kg: s.Mms_kg.value,
    Cms_m_per_N: s.Cms_m_per_N.value,
    Vas_m3: s.Vas_m3.value,
    Qms: s.Qms.value,
  };
}
