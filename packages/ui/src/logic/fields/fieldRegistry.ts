...
const FIELDS: FieldSpec[] = [
  ...
  { id: 'dimThick', label: 'Basket Plate Thickness (Thick)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 0.3, provenance: 'entered', modeled: true, appliesTo: 'all', description: 'Frame flange thickness. Carried through .wdr export; not simulated.' },
  { id: 'dimDepth', label: 'Driver Depth (Depth)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 5, provenance: 'entered', modeled: true, appliesTo: 'all', description: 'Overall driver depth. Carried through .wdr export; not simulated.' },
