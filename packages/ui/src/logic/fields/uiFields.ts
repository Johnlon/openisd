...
export interface UIFieldSpec<TEntity = any, TValue = unknown> {
  ...
  readonly handle?: (entity: TEntity) => TValue;
...
const UI_FIELD_SPECS: UIFieldSpec[] = [
  ...
  { id: 'driver_Dd_mm', aliases: ['Dd_m', 'Dd'], label: 'Dd', pane: 'Driver: Parameters', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 2, provenance: 'entered', appliesTo: 'all', domainKey: 'Dia_m', description: 'Effective Diaphragm Diameter: Effective piston diameter of the cone, interchangeable with Sd (Sd = π · (Dd / 2)²).' },
  { id: 'driver_fLe_hz', aliases: ['fLe_hz'], label: 'fLe', pane: 'Driver: Parameters', kind: 'number', unit: 'kHz', precision: 5, min: 0, max: 100000, provenance: 'entered', appliesTo: 'all', domainKey: 'fLe_hz', description: 'Semi-Inductance Reference Frequency: Frequency at which voice coil semi-inductance parameters Le and KLe were measured.' },
  { id: 'driver_KLe_H_sqrtHz', aliases: ['KLe_H_sqrtHz'], label: 'KLe', pane: 'Driver: Parameters', kind: 'number', unit: 'H·√Hz', precision: 6, min: 0, max: 10, provenance: 'entered', appliesTo: 'all', domainKey: 'KLe_H_sqrtHz', description: 'Semi-Inductance Coefficient: Semi-inductance loss factor accounting for eddy currents and high-frequency coil losses.' },
  { id: 'driver_Hc_mm', aliases: ['Hc_m', 'Hc'], label: 'Hc', pane: 'Driver: Parameters', kind: 'number', unit: 'm', precision: 3, min: 0, max: 1, provenance: 'entered', appliesTo: 'all', domainKey: 'Hc_m', description: 'Voice Coil Height: Winding height of the voice coil wire on the former.' },
  { id: 'driver_Hg_mm', aliases: ['Hg_m', 'Hg'], label: 'Hg', pane: 'Driver: Parameters', kind: 'number', unit: 'm', precision: 3, min: 0, max: 1, provenance: 'entered', appliesTo: 'all', domainKey: 'Hg_m', description: 'Magnetic Gap Height: Physical thickness of the top plate defining the magnetic gap height.' },
  { id: 'driver_Vd_cm3', aliases: ['Vd_m3', 'Vd'], label: 'Vd', pane: 'Driver: Parameters', kind: 'number', unit: 'cm³', precision: 0, min: 0, max: 100000, provenance: 'calculated', appliesTo: 'all', domainKey: 'Vd_m3', description: 'Peak Displacement Volume: Maximum volume of air displaced by the cone at full linear excursion Xmax (Vd = Sd × Xmax).' },
  { id: 'driver_Xlim_mm', aliases: ['Xlim_m', 'Xlim'], label: 'Xlim', pane: 'Driver: Parameters', kind: 'number', unit: 'm', precision: 3, min: 0, max: 1, provenance: 'entered', appliesTo: 'all', domainKey: 'Xlim_m', description: 'Mechanical Excursion Limit: Absolute physical displacement limit before mechanical damage or bottoming occurs.' },
  { id: 'driver_Eta0', aliases: ['no'], label: 'η₀', pane: 'Driver: Parameters', kind: 'number', unit: '%', unitGroup: 'percent', precision: 4, min: 0, max: 100, provenance: 'calculated', appliesTo: 'all', domainKey: 'no', description: 'Reference Efficiency: How effectively a speaker converts electrical power into acoustic sound power in its passband (η₀ = P_acc / P_elec × 100%).' },
  { id: 'driver_USPL_dB', aliases: ['USPL_dB'], label: 'USPL', pane: 'Driver: Parameters', kind: 'number', unit: 'dB', precision: 2, min: 0, max: 200, provenance: 'calculated', appliesTo: 'all', domainKey: 'USPL_dB', formula: 'USPL = SPL + 10·log₁₀(8/Re)', dependsOn: ['SPL', 'Re'], description: 'Voltage Sensitivity: Sound pressure level at 1 meter produced by a standard 2.83 V RMS input voltage.' },
  { id: 'driver_SPL_dB', aliases: ['SPL_dB'], label: 'SPL', pane: 'Driver: Parameters', kind: 'number', unit: 'dB', precision: 2, min: 0, max: 200, provenance: 'calculated', appliesTo: 'all', domainKey: 'SPL_dB', description: 'Power Sensitivity: Sound pressure level at 1 meter produced by a 1 Watt electrical power input.' },
  { id: 'driver_NumVC', aliases: ['numVC'], label: 'Voicecoils', pane: 'Driver: Parameters', kind: 'number', unit: '', precision: 0, min: 1, max: 4, provenance: 'entered', appliesTo: 'all', domainKey: 'numVC', description: 'Voice Coil Count: Number of independent voice coil windings on the driver motor assembly.' },
  { id: 'driver_VCCon', aliases: ['VCCon'], label: 'Connection', pane: 'Driver: Parameters', kind: 'enum', unit: '', provenance: 'entered', appliesTo: 'all', options: VC_CONNECTION_OPTIONS, domainKey: 'VCCon', description: 'Voice Coil Wiring: Wiring configuration (series or parallel) for multi-voice-coil drivers determining total terminal resistance Re and BL.' },
  { id: 'driver_AlfaVC_per_K', aliases: ['alfaVC_per_K', 'alfaVC'], label: 'AlfaVC', pane: 'Driver: Advanced', kind: 'number', unit: '1000/K', precision: 4, min: 0, max: 0.1, provenance: 'entered', appliesTo: 'all', domainKey: 'alfaVC_per_K', description: 'Voice Coil Temp Coefficient: Thermal resistance coefficient of voice coil wire, determining resistance rise per degree of heating.' },
  { id: 'driver_Rt_K_per_W', aliases: ['Rt_K_per_W'], label: 'R(t)', pane: 'Driver: Advanced', kind: 'number', unit: 'K/W', precision: 5, min: 0, max: 1000, provenance: 'entered', appliesTo: 'all', description: 'Thermal Resistance: Thermal resistance from voice coil to magnet assembly and ambient air.' },
  { id: 'driver_Ct_J_per_K', aliases: ['Ct_J_per_K'], label: 'C(t)', pane: 'Driver: Advanced', kind: 'number', unit: 'J/K', precision: 5, min: 0, max: 10000, provenance: 'entered', appliesTo: 'all', description: 'Thermal Capacitance: Heat storage capacity of the voice coil and motor structure.' },
  { id: 'driver_EBP_hz', aliases: ['EBP_hz', 'EBP'], label: 'EBP', pane: 'Driver: Advanced', kind: 'number', unit: 'Hz', precision: 2, min: 0, max: 1000, provenance: 'calculated', appliesTo: 'all', domainKey: 'EBP_hz', formula: 'EBP = Fs/Qes', dependsOn: ['Fs', 'Qes'], description: 'Efficiency Bandwidth Product: Ratio of Fs to Qes (Fs / Qes); indicates enclosure suitability (EBP < 50 favours sealed, > 90 favours vented).' },
  { id: 'driver_SPLmaxLF_dB', aliases: ['SPLmaxLF_dB'], label: 'SPLmaxLF', pane: 'Driver: Advanced', kind: 'number', unit: 'dB', precision: 2, min: 0, max: 200, provenance: 'calculated', appliesTo: 'all', domainKey: 'SPLmaxLF_dB', formula: 'SPLmaxLF = 20·log₁₀(ρ₀·(2π·20)²·Vd / (2π√2) / P0)', dependsOn: ['Vd'], description: 'Low Frequency Excursion Limit SPL: Theoretical maximum sound pressure level at 20 Hz limited strictly by peak diaphragm excursion Xmax.' },
  { id: 'driver_SPLmax_dB', aliases: ['SPLmax_dB'], label: 'SPLmax', pane: 'Driver: Advanced', kind: 'number', unit: 'dB', precision: 2, min: 0, max: 200, provenance: 'calculated', appliesTo: 'all', domainKey: 'SPLmax_dB', formula: 'SPLmax = SPL + 10·log₁₀(Pe) − 3', dependsOn: ['SPL', 'Pe'], description: 'Thermally Limited Max SPL: Maximum acoustic sound pressure level when driven at full thermal power rating Pe.' },
  { id: 'driver_Rme_Ns_per_m', aliases: ['Rme_kg_per_s', 'Rme'], label: 'Rme', pane: 'Driver: Advanced', kind: 'number', unit: 'Ns/m', unitGroup: 'resistance', precision: 5, min: 0, max: 1000, provenance: 'calculated', appliesTo: 'all', domainKey: 'Rme_kg_per_s', formula: 'Rme = 2π·Fs·Mms/Qes (= Bl²/Re)', dependsOn: ['Fs', 'Mms', 'Qes'], description: 'Motional Resistance at Resonance: Electromagnetic damping resistance generated by back-EMF at resonance.' },
  { id: 'driver_Gamma', aliases: ['gamma_m_per_s2_A', 'gamma'], label: 'gamma', pane: 'Driver: Advanced', kind: 'number', unit: 'N/(A·kg)', precision: 5, min: 0, max: 100000, provenance: 'calculated', appliesTo: 'all', domainKey: 'gamma_m_per_s2_A', formula: 'gamma = Bl/Mms', dependsOn: ['Bl', 'Mms'], description: 'Acceleration Factor: Ratio of motor force BL to moving mass Mms, measuring initial cone acceleration per ampere.' },
  { id: 'driver_Mpow', aliases: ['Mpow_N_per_sqrtW', 'Mpow'], label: 'Mpow', pane: 'Driver: Advanced', kind: 'number', unit: 'N/√W', precision: 5, min: 0, max: 1000, provenance: 'calculated', appliesTo: 'all', domainKey: 'Mpow_N_per_sqrtW', formula: 'Mpow = √Rme (= Bl/√Re)', dependsOn: ['Rme'], description: 'Power-Normalized Motor Force: Motor force produced per square root of input power (BL / √Re).' },
  { id: 'driver_Mcost_kg_per_s', aliases: ['Mcost_kg_per_s', 'Mcost'], label: 'Mcost', pane: 'Driver: Advanced', kind: 'number', unit: 'kg/s', unitGroup: 'resistance', precision: 5, min: 0, max: 1000, provenance: 'calculated', appliesTo: 'all', domainKey: 'Mcost_kg_per_s', formula: 'Mcost = Rme·(1 + Xmax/min(Hc, Hg))', dependsOn: ['Rme', 'Xmax', 'Hc', 'Hg'], description: 'Motor Figure of Merit: Dynamic electromagnetic coupling efficiency accounting for gap geometry and displacement.' },
  { id: 'driver_Gloss_pct', aliases: ['Gloss'], label: 'Gloss', pane: 'Driver: Advanced', kind: 'number', unit: '%', unitGroup: 'percent', precision: 4, min: 0, max: 100, provenance: 'calculated', appliesTo: 'all', domainKey: 'Gloss', formula: 'Gloss = g/((2π·Fs)²·Xmax), g = 9.80665', dependsOn: ['Fs', 'Xmax'], description: 'Gravity Sag Percentage: Percentage of peak excursion Xmax consumed by cone displacement under gravity when mounted horizontally.' },
  { id: 'driver_Thick_mm', aliases: ['Thick_m', 'Thick'], label: 'Basket Plate Thickness (Thick)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 0.3, provenance: 'entered', appliesTo: 'all', description: 'Basket Flange Thickness: Frame flange plate thickness at the mounting boundary.' },
  { id: 'driver_Depth_mm', aliases: ['Depth_m', 'Depth'], label: 'Driver Depth (Depth)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 5, provenance: 'entered', appliesTo: 'all', description: 'Overall Driver Depth: Total physical depth of the driver from mounting flange to rear magnet pole plate.' },
  { id: 'driver_MagDepth_mm', aliases: ['MagDepth_m', 'MagDepth'], label: 'Magnet Depth', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 5, provenance: 'entered', appliesTo: 'all', description: 'Magnet Assembly Depth: Physical thickness of the rear magnet assembly.' },
  { id: 'driver_Magnet_mm', aliases: ['Magnet_m', 'Magnet'], label: 'Magnet Diameter (Magnet)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 5, provenance: 'entered', appliesTo: 'all', description: 'Magnet Diameter: Outer diameter of the motor magnet structure.' },
  { id: 'driver_Basket_mm', aliases: ['Basket_m', 'Basket'], label: 'Basket Diameter (Basket)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 5, provenance: 'entered', appliesTo: 'all', description: 'Basket Diameter: Outer frame chassis diameter.' },
  { id: 'driver_Outer_mm', aliases: ['Outer_m', 'Outer'], label: 'Outer Diameter (Outer)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 5, provenance: 'entered', appliesTo: 'all', description: 'Outer Mounting Diameter: Overall diameter of the front mounting flange.' },
  { id: 'driver_Vcd_mm', aliases: ['Vcd_m', 'Vcd'], label: 'Voice Coil Dia (Vcd)', pane: 'Driver: Dimensions', kind: 'number', unit: 'mm', precision: 2, min: 0, max: 1, provenance: 'entered', appliesTo: 'all', description: 'Voice Coil Diameter: Former diameter of the voice coil winding.' },
  { id: 'driver_Dvol_cm3', aliases: ['DVol_m3', 'DVol'], label: 'Driver Displacement Volume (DVol)', pane: 'Driver: Dimensions', kind: 'number', unit: 'cm³', precision: 2, min: 0, max: 1, provenance: 'entered', appliesTo: 'all', description: 'Driver Displacement Volume: Volume occupied by the driver motor and basket inside the enclosure.' },

  // ── Driver: General ──
  { id: 'driver_manufacturer', aliases: ['manufacturer'], label: 'Manufacturer', pane: 'Driver: General', kind: 'text', unit: '', provenance: 'entered', appliesTo: 'all', description: 'Manufacturer: Company or organization that designed and manufactured the driver.' },
  { id: 'driver_brand', aliases: ['brand'], label: 'Brand', pane: 'Driver: General', kind: 'text', unit: '', provenance: 'entered', appliesTo: 'all', description: 'Brand: Trade brand name under which the driver is marketed.' },
  { id: 'driver_model', aliases: ['model'], label: 'Model', pane: 'Driver: General', kind: 'text', unit: '', provenance: 'entered', appliesTo: 'all', description: 'Model: Manufacturer model designation or part number.' },
  { id: 'driver_providedBy', aliases: ['providedBy'], label: 'Data provided by', pane: 'Driver: General', kind: 'text', unit: '', provenance: 'entered', appliesTo: 'all', description: 'Data Attribution: Source contributor or measurement laboratory providing the parameter data.' },
  { id: 'driver_added', aliases: ['added'], label: 'Date added', pane: 'Driver: General', kind: 'date', unit: '', provenance: 'entered', appliesTo: 'all', description: 'Date Added: Date when the driver parameter record was cataloged.' },
  { id: 'driver_comment', aliases: ['comment'], label: 'Comment', pane: 'Driver: General', kind: 'text', unit: '', provenance: 'entered', appliesTo: 'all', description: 'Driver Notes: Free-text engineering notes and comments associated with the driver record.' },

  { id: 'driver_Znom_ohm', aliases: ['Znom_ohm', 'Znom'], label: 'Znom', pane: 'Driver: Parameters', kind: 'number', unit: 'ohm', precision: 0, min: 0, max: 64, provenance: 'entered', appliesTo: 'all', domainKey: 'Znom_ohm', description: 'Nominal Impedance: Rated speaker impedance classification (e.g. 4, 8, or 16 ohms) for amplifier matching.' },

  { id: 'driver_c_m_per_s', aliases: ['c_m_per_s'], label: 'c', pane: 'Driver: Advanced', kind: 'number', unit: 'm/s', unitGroup: 'velocity', precision: 2, min: 0, max: 1000, provenance: 'calculated', appliesTo: 'all', description: 'Reference Speed of Sound: Velocity of acoustic propagation at reference environmental conditions.' },
  { id: 'driver_roo_kg_per_m3', aliases: ['roo_kg_per_m3'], label: 'roo', pane: 'Driver: Advanced', kind: 'number', unit: 'kg/m³', unitGroup: 'density', precision: 5, min: 0, max: 10, provenance: 'calculated', appliesTo: 'all', description: 'Reference Air Density: Atmospheric mass density at reference environmental conditions.' },

  // ── Box readouts ──
  { id: 'box_Resonance_hz', aliases: ['boxResonance'], label: 'Fsc / Fh', pane: 'Box', kind: 'number', unit: 'Hz', unitGroup: 'freq', precision: 2, min: 0, max: 20000, provenance: 'calculated', appliesTo: 'all', description: 'System Resonance Frequency: Effective total resonance frequency of the driver coupled to the enclosure.' },
  { id: 'box_RearResonance_hz', aliases: ['rearResonance', 'boxRearResonance'], label: 'Frc', pane: 'Box', kind: 'number', unit: 'Hz', unitGroup: 'freq', precision: 2, min: 0, max: 20000, provenance: 'calculated', appliesTo: ['bandpass4'], description: 'Rear Chamber Resonance: Sealed rear-chamber resonance frequency in a 4th-order bandpass enclosure (Frc = Fs × √(1 + Vas/Vb)).' },
  { id: 'box_Frc_hz', aliases: ['Frc'], label: 'Tuning freq (Frc)', pane: 'Box', kind: 'number', unit: 'Hz', unitGroup: 'freq', precision: 2, min: 0, max: 20000, provenance: 'entered', appliesTo: ['bandpass6', 'abc'], description: 'Rear Chamber Tuning Frequency: Target Helmholtz tuning frequency for the vented rear chamber in 6th-order bandpass and ABC enclosures.' },
  ...
  { id: 'driver_VcTempRise_K', aliases: ['vcTempRise', 'driverVcTempRise'], label: 'Voice coil temp rise', pane: 'Driver', kind: 'number', unit: 'K', precision: 2, min: 0, max: 500, provenance: 'entered', appliesTo: 'all', description: 'Voice Coil Temp Rise: Voice coil heating caused by electrical power dissipation (I² Re), increasing coil resistance Re and inducing thermal power compression.' },
  { id: 'driver_AddedMass_g', aliases: ['driverAddedMass'], label: 'Added mass to cone', pane: 'Driver', kind: 'number', unit: 'g', precision: 5, min: 0, max: 5, provenance: 'entered', appliesTo: 'all', description: 'Cone Added Mass: Test mass temporarily added to the cone to shift resonant frequency (Fs), allowing calculation of suspension compliance (Cms) and moving mass (Mms).' },

  // ============================ FILTERS ============================
  { id: 'filter_Fc_hz', aliases: ['filterFc'], label: 'Cutoff / Center freq', pane: 'Filters', kind: 'number', unit: 'Hz', precision: 3, min: 1, max: 20000, provenance: 'entered', appliesTo: 'all', description: 'Cutoff / Center Frequency: Cutoff or center frequency of the active signal filter.' },
  { id: 'filter_Q', aliases: ['filterQ'], label: 'Q', pane: 'Filters', kind: 'number', unit: '', precision: 3, min: 0.1, max: 100, provenance: 'entered', appliesTo: 'all', description: 'Filter Quality Factor: Quality factor determining resonance peak sharpness or damping of the filter.' },
  { id: 'filter_Gain_dB', aliases: ['filterGain'], label: 'Gain', pane: 'Filters', kind: 'number', unit: 'dB', precision: 3, min: -60, max: 60, provenance: 'entered', appliesTo: 'all', description: 'Filter Gain: Boost or attenuation gain applied by the equalizer or filter in dB.' },
  { id: 'filter_Order', aliases: ['filterOrder'], label: 'Order', pane: 'Filters', kind: 'number', unit: '', precision: 3, min: 1, max: 8, provenance: 'entered', appliesTo: 'all', description: 'Filter Order: Filter steepness order (e.g. 1st order 6 dB/oct, 2nd order 12 dB/oct, 4th order 24 dB/oct).' },
];

const UI_FIELDS_BY_ID = new Map<string, UIFieldSpec>();
for (const spec of UI_FIELD_SPECS) {
  UI_FIELDS_BY_ID.set(spec.id, spec);
  if (spec.aliases) {
    for (const alias of spec.aliases) {
      UI_FIELDS_BY_ID.set(alias, spec);
    }
  }
}
