...
const UI_FIELD_SPECS: UIFieldSpec[] = [
  ...
  },
  {
    ...
    description: 'Controls sealed resonance (Fsc) and system Q (Qtc) loss calculations: None (ideal lossless Q=inf), WinISD default (lossy cubic Ql=10, Qa=100, Qp=100), or Custom Q.',
  },
  {
  ...
  },
  {
    ...
    description: 'Pe — CONTINUOUS (thermal/RMS) power handling: the maximum power the voice coil dissipates indefinitely without thermal failure. Not the datasheet\'s peak/short-term rating — see "Peak power" for that.',
  },
  {
    ...
    description: 'Peak power — SHORT-TERM (non-continuous) power handling, above Pe\'s continuous figure. An OpenISD-only field: WinISD\'s .wdr format has no slot for it, so it is never read from or written to a .wdr/.wpr file.',
  },
  {
  ...
  { id: 'driver_model', aliases: ['model'], label: 'Model', pane: 'Driver: General', kind: 'text', unit: '', description: 'Model: Manufacturer model designation or part number. Examples:\nW5-1138SMF\nRS270-8 10" Reference Woofer 8 Ohm' },
  { id: 'driver_sku', aliases: ['sku'], label: 'Part Number', pane: 'Driver: General', kind: 'text', unit: '', description: 'Manufacturer\'s Part Number (SKU): the exact code from the datasheet. Examples:\nW5-1138SMF (Tang Band)\nRS270-8 (Dayton Audio)\n10PR-8 (GRS)\nSB13PFCR-00 (SB Acoustics)\n10FH520-4 (FaitalPRO)\nKappalite-3015 (Eminence)' },
