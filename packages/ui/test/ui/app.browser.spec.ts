...
// `box.vented.tuning_goal_hz` even for bandpass4 (OriginalShell.vue), while the front-vent
// solve reads `box.bandpass4.chambers.front.tuning_goal_hz` (openisdDomain.resolve) — so the
