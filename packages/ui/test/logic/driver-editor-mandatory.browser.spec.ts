...
// always carries a "charts stay blank because … imply …" strip and a sku-derived Model cell
// that cannot be emptied. That noise is exactly what these assertions must not depend on.
