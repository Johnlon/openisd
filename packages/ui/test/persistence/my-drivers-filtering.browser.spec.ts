...
// and nominal impedance — and whose `driver_type` labels put them under different type chips.
const SAVED: SeedDriver[] = [
  ...
  { brand: 'Bench', model: 'Silk Dome Tweeter', driverType: DriverType.Tweeter, specs: { Fs_hz: 900, Qts: 0.5, Qes: 0.6, Qms: 3,
