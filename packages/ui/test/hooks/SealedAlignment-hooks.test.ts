...
function completeProject() {
  ...
  project.driver.spec.woofer.Qts.set(0.38);
  project.driver.spec.woofer.Qes.set(0.45);
  project.driver.spec.woofer.Vas_m3.set(0.03);
...
describe('createSealedAlignmentEditor', () => {
  it('keeps alignment edits in draft state until Accept', () => {
    ...
    expect(project.box.sealed.volume_m3.get()).toBe(0.012);
