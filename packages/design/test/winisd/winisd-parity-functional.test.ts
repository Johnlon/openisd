...
function driverFieldCell(d: OpenISDDriver, field: string): Readable<number | null> | undefined {
  const spec = d.specs;
  switch (field) {
    case 'Fs': return spec.Fs_hz;
    case 'Re': return spec.Re_ohm;
    case 'Qts': return spec.Qts;
    case 'Qes': return spec.Qes;
    case 'Qms': return spec.Qms;
    case 'Cms': return spec.Cms_m_per_N;
    case 'Mms': return spec.Mms_kg;
    case 'Rms': return spec.Rms_kg_per_s;
    case 'BL': return spec.BL_Tm;
    case 'Sd': return spec.Sd_m2;
    case 'Vas': return spec.Vas_m3;
    case 'Dd': return spec.Dd_m;
    case 'Vd': return spec.Vd_m3;
    case 'no': return spec.no;
    case 'SPL': return spec.SPL_dB;
    case 'USPL': return spec.USPL_dB;
    case 'SPLmax': return spec.SPLmax_dB;
    case 'SPLmaxLF': return spec.SPLmaxLF_dB;
    case 'gamma': return spec.gamma_m_per_s2_A;
    case 'Rme': return spec.Rme_kg_per_s;
    case 'Mpow': return spec.Mpow_N_per_sqrtW;
    case 'Mcost': return spec.Mcost_kg_per_s;
    case 'Gloss': return spec.Gloss;
    case 'c': return spec.c_m_per_s;
    case 'roo': return spec.roo_kg_per_m3;
...
function solvedFieldValue(solved: OpenISDDriver['specs'], field: string): number | undefined {
  switch (field) {
...
function num(drv: OpenISDDriver, field: string): number | null {
  ...
  const v = solvedFieldValue(drv.specs, field);
